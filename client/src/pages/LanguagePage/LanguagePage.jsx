...
const LanguagePage = () => {
  ...
  const fetchMasterGrid = async () => {
    ...
    setError("");
    try {
      const res = await axiosClient.get("/common/master-grid/DCS_M_LANGUAGE");
  ...
  const handleEdit = (rowData) => {
    const mappedRow = {
      languageId: rowData.Language_ID || 0,
      languageName: rowData.Language_Name || "",
      inactiveReason: rowData.C2C_Inactive_Reason || "",
      status: rowData.C2C_Status === 1, // ✅ converts numeric status to boolean
